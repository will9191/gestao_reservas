  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="bg-light-airbnb rounded-xl shadow text-white px-4 py-2 m-2 h-fit hover:bg-airbnb-200 transition delay-50 duration-300 ease-in-out hover:scale-110 active:bg-airbnb-300 disabled:hover:scale-100 disabled:cursor-not-allowed disabled:hover:bg-light-airbnb"
      >
        Reservar
      </button>
    </div>
